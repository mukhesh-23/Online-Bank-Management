...
@ManagedBean(name = "withdraw", eager = true)
@SessionScoped
        ...
        try (Connection con = ds.getConnection()) {
            ...
            if (rs.next()) {
                ...
                if (pass.equals(password)) {
                    ...
                    if (rowsAffected > 0) {
                        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Amount withdrawn successfully", null));
                        ...
                        insertTransaction.setString(4, "Withdraw");
                        ...
                        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error in withdraw amount", null));
                    }
                } else {
